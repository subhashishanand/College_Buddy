//package com.printhub.printhub.notification;
//
//import android.content.Intent;
//import android.util.Log;
//import android.widget.Toast;
//
//import com.beingdev.magicprint.MainnewActivity;
...
//        //Else, if we have not set any additional data MainnewActivity is opened.
//        if (data != null) {
...
//            } else if (activityToBeOpened != null && activityToBeOpened.equals("MainnewActivity")) {
//                Log.i("OneSignalExample", "customkey set with value: " + activityToBeOpened);
//                Intent intent = new Intent(CustomApplication.getContext(), MainnewActivity.class);
//                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_NEW_TASK);
//                CustomApplication.getContext().startActivity(intent);
//            } else {
//                Intent intent = new Intent(CustomApplication.getContext(), MainnewActivity.class);
